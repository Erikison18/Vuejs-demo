...
<template>
  <div>
		...
		<div class="content">
			<div class="header clear"><h2><img :src="dataList.author_face" alt=""/></h2><p>智能社</p></div>
        <div class="cont">
          <h3>{{dataList.title}}</h3>
            <div class="time"><p>{{dataList.time | normalTime}} <span><img src="../../assets/img/zan.png" alt=""/></span></p></div>
            <div class="text-box" v-html="dataList.content"></div>
        </div>
		</div>
		<div class="foot-btn">
			<ul>
